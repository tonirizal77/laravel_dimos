                ...
                <div class="col-lg-8 entries">
                    ...
                    <article class="entry entry-single">
                        ...
                        <div class="entry-content">
                            ...
                            <img src="{{asset('ui_users/assets/img/blog-inside-post.jpg')}}" class="img-fluid" alt="">
                    ...
                    <div class="blog-author clearfix">
                        <img src="{{asset('ui_users/assets/img/blog-author.jpg')}}" class="rounded-circle float-left"
                            alt="">
                        <h4>Jane Smith</h4>
                    ...
                    <div class="blog-comments">
                        ...
                        <div id="comment-1" class="comment clearfix">
                            <img src="{{asset('ui_users/assets/img/comments-1.jpg')}}" class="comment-img  float-left"
                                alt="">
                            <h5><a href="">Georgia Reader</a> <a href="#" class="reply"><i class="icofont-reply"></i>
                                    Reply</a></h5>
                        ...
                        <div id="comment-2" class="comment clearfix">
                            <img src="{{asset('ui_users/assets/img/comments-2.jpg')}}" class="comment-img  float-left"
                                alt="">
                            <h5><a href="">Aron Alvarado</a> <a href="#" class="reply"><i class="icofont-reply"></i>
                                    Reply</a></h5>
                            <time datetime="2020-01-01">01 Jan, 2020</time>
                            <p>
                            ...
                            <div id="comment-reply-1" class="comment comment-reply clearfix">
                                <img src="{{asset('ui_users/assets/img/comments-3.jpg')}}"
                                    class="comment-img  float-left" alt="">
                                <h5><a href="">Lynda Small</a> <a href="#" class="reply"><i class="icofont-reply"></i>
                                        Reply</a></h5>
                                <time datetime="2020-01-01">01 Jan, 2020</time>
                                <p>
                                ...
                                <div id="comment-reply-2" class="comment comment-reply clearfix">
                                    <img src="{{asset('ui_users/assets/img/comments-4.jpg')}}"
                                        class="comment-img  float-left" alt="">
                        ...
                        <div id="comment-3" class="comment clearfix">
                            <img src="{{asset('ui_users/assets/img/comments-5.jpg')}}" class="comment-img  float-left"
                                alt="">
                            <h5><a href="">Nolan Davidson</a> <a href="#" class="reply"><i class="icofont-reply"></i>
                                    Reply</a></h5>
                            <time datetime="2020-01-01">01 Jan, 2020</time>
                            <p>
                        ...
                        <div id="comment-4" class="comment clearfix">
                            <img src="{{asset('ui_users/assets/img/comments-6.jpg')}}" class="comment-img  float-left"
                                alt="">
                            <h5><a href="">Kay Duggan</a> <a href="#" class="reply"><i class="icofont-reply"></i>
                                    Reply</a></h5>
                            <time datetime="2020-01-01">01 Jan, 2020</time>
                            <p>
                    ...
                    <div class="sidebar">
                        ...
                        <div class="sidebar-item recent-posts">
                            <div class="post-item clearfix">
                                <img src="{{asset('ui_users/assets/img/blog-recent-1.jpg')}}" alt="">
                                <h4><a href="#">Nihil blanditiis at in nihil autem</a></h4>
                                <time datetime="2020-01-01">Jan 1, 2020</time>
                            </div>

                            <div class="post-item clearfix">
                                <img src="{{asset('ui_users/assets/img/blog-recent-2.jpg')}}" alt="">
                                <h4><a href="#">Quidem autem et impedit</a></h4>
                                <time datetime="2020-01-01">Jan 1, 2020</time>
                            </div>

                            <div class="post-item clearfix">
                                <img src="{{asset('ui_users/assets/img/blog-recent-3.jpg')}}" alt="">
                                <h4><a href="#">Id quia et et ut maxime similique occaecati ut</a></h4>
                                <time datetime="2020-01-01">Jan 1, 2020</time>
                            </div>

                            <div class="post-item clearfix">
                                <img src="{{asset('ui_users/assets/img/blog-recent-4.jpg')}}" alt="">
                                <h4><a href="#">Laborum corporis quo dara net para</a></h4>
                                <time datetime="2020-01-01">Jan 1, 2020</time>
                            </div>

                            <div class="post-item clearfix">
                                <img src="{{asset('ui_users/assets/img/blog-recent-5.jpg')}}" alt="">
