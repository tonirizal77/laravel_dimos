        ...
        <div class="container">
            ...
            <div class="portfolio-details-container">
                ...
                <div class="owl-carousel portfolio-details-carousel">
                    <img src="{{asset('ui_users/assets/img/portfolio/portfolio-details-1.jpg')}}" class="img-fluid"
                        alt="">
                    <img src="{{asset('ui_users/assets/img/portfolio/portfolio-details-2.jpg')}}" class="img-fluid"
                        alt="">
                    <img src="{{asset('ui_users/assets/img/portfolio/portfolio-details-3.jpg')}}" class="img-fluid"
                        alt="">
                </div>
