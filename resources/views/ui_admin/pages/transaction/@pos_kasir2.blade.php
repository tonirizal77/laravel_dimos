...
@section('css-x')
    <!-- DataTables -->
    <link rel="stylesheet" href="{{ asset('ui_admin/plugins/datatables-bs4/css/dataTables.bootstrap4.min.css')}}">
    <link rel="stylesheet" href="{{ asset('ui_admin/plugins/datatables-responsive/css/responsive.bootstrap4.min.css')}}">
    <link rel="stylesheet" href="{{ asset('ui_admin/plugins/datatables-buttons/css/buttons.bootstrap4.min.css')}}">
    <link rel="stylesheet" href="{{ asset('ui_admin/plugins/datatables-keytable/css/keyTable.bootstrap4.min.css')}}">
    <!-- This Page -->
                                ...
                                <div class="PrintArea delivery uk80 d-block" id="struk_do">
                                    <div class="col-12">
                                        ...
                                        <table class="table p-1" id="tabel_do">
                                            ...
                                            <tfoot class="text-bold">
                                                <tr>
                                                    <td style="border-top: 1px solid !important;" class="justify-content-between row">
                                                        <div class="col-8">
...
@section('js-x')
    ...
    {{-- <script src="{{ asset('ui_admin/plugins/jquery-validation/jquery.validate.min.js')}}"></script> --}}
    {{-- <script src="{{ asset('ui_admin/plugins/jquery-validation/additional-methods.min.js')}}"></script> --}}
