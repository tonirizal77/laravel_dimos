            ...
            success: function (resp) {
                ...
                if (data.length == 0) {
                    ...
                    for (let i = 0; i < data.length; i++) {
                        ...
                        if (data[i].tipe == "1") {
                            sw_tipe_name = "Distributor"
                        } else if (data[i].tipe == "2") {
                            sw_tipe_name = "Store";
                        } else if (data[i].tipe == "3") {
                            sw_tipe_name = "Customer";
                        } else if (data[i].tipe == "4") {
                            sw_tipe_name = "Supplier";
                        } else {
                            sw_tipe_name = "User";
                        }
                        ...
                        let rowdata =
                            `<tr tabindex="`+no+`" data-id="`+data[i].id+`">
                                ...
                                <td tabindex="3" class="text-center tipe">`+sw_tipe_name+` - `+sw_tipe_role+`</td>
            ...
            $.ajax({
                ...
                success: function (resp) {
                    ...
                    if (action == "Tambah") {
                        ...
                        $(cell[3]).text(sw_tipe_name+` - `+sw_tipe_role);
