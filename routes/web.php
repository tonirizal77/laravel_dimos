 ...
 * source 3 : https://www.youtube.com/watch?v=zEKaQxVIG8I&list=RDCMUC4wUtPE3ZqC3kgLXz--rjrQ&start_radio=1&rv=zEKaQxVIG8I&t=52
*/
...
Route::middleware(['auth'])->group(function () {
    ...
    */
    ...
    Route::resource('dashboard', DashboardController::class)->except(['store','create','show','edit','destroy']);
    // Route::get('dashboard', [DashboardController::class, 'index']);

    // Group route ADMIN
    Route::group(['middleware' => ['role:admin,user,kasir']], function () {
